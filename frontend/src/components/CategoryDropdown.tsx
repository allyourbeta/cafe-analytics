  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="min-w-[200px] px-4 py-2.5 border-2 border-gray-200 rounded-lg text-sm font-medium text-gray-700 bg-white hover:border-orange-400 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-all duration-200 flex items-center justify-between gap-3"
      >
