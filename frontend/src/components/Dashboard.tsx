...
export default function Dashboard() {
    ...
    return (
        <>
            ...
            {/* Decorative stripe */}
            <div
                className="h-1.5 w-full bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 rounded-full mb-8 shadow-lg shadow-orange-500/20"/>
            ...
            <div className="flex gap-6">
                ...
                {isMobileMenuOpen && (
                    <>
                        ...
                        {/* Drawer */}
                        <aside
                            className="fixed top-0 left-0 bottom-0 w-80 bg-white z-50 lg:hidden shadow-2xl animate-slide-in">
